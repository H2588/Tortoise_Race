...
namespace Tortoise_Race
{
    public partial class Form1 : Form
    {
        ...
        private void GuyRadioButtons()
        {
            ...
            myGuy[1].MyRadioButton.Text = "Cheng";
        ...
        private void LBLs()
        {
            ...
            myProperty.LBLCheng = myProperty.NotBetYet;
        ...
        private void GuyNotBetYet()
        {
            ...
            lblSam.Text = myGuy[1].GuyName + myProperty.LBLCheng;
            ...
            for (myProperty.Guy = 0; myProperty.Guy < 3; myProperty.Guy++)
            {
                ...
                else
                {
                    ...
                    if (myGuy[myProperty.Guy].MaxCash == 0)
                    {
                        ...
                        {
                            myProperty.LBLCheng = myProperty.Busted;
                            lblSam.Text = myGuy[1].GuyName + myProperty.LBLCheng;
        ...
        private void RestartRace()
        {
            ...
            if (myProperty.LBLJong == " you have run out of Cash! BUSTED!" && myProperty.LBLCheng == " you have run out of Cash! BUSTED!" && myProperty.LBLJosh == " you have run out of Cash! BUSTED!")
            {
